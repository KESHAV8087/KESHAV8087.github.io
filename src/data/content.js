...
export const projects = [
  {
    id: "cotiviti-policy",
    num: "01",
    title: "NCCI Policy-to-Rules (Agentic LLM)",
    desc: "Agentic system that converts CMS healthcare coding policy into structured, source-grounded rules. A tool-calling LLM extracts rules while a deterministic grounding check verifies every rule's quote against the source text — separating generation from verification so hallucinated rules get flagged, not trusted. Built for the Cotiviti GenAI assessment; ~88% faithfulness / 86% recall on a labeled eval set.",
    tech: ["Python", "LLM Agents", "Streamlit", "Groq"],
    category: "AI/ML",
    github: "https://github.com/KESHAV8087/cotiviti-policy-to-rules",
  },
  {
    id: "payment-risk",
    num: "02",
    title: "AI-Powered Payment Risk Engine",
    desc: "Hybrid fraud-detection system (team of 2, CS6140). A calibrated XGBoost classifier scores transactions (PR-AUC 0.87 vs 0.18 baseline), a cost-sensitive threshold turns scores into approve/review/decline decisions, SHAP identifies driving factors, and a Groq LLaMA 3.3 70B model generates plain-language explanations checked for faithfulness against the SHAP factors (mean 0.974).",
    tech: ["Python", "XGBoost", "SHAP", "Streamlit"],
    category: "AI/ML",
    github: "https://github.com/KESHAV8087/Payment-Risk-Engine",
  },
  {
    id: "rag-eval",
    num: "03",
